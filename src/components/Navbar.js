            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link active" aria-current="page" to="/about" style={{color: props.mode==='light'?'black':'white'}}>About</Link>
                        </li>
                    </ul>
                    <div className="form-check form-switch form-check">
                        ...
                        <label className="form-check-label" for="flexSwitchCheckReverse" style={{color: props.mode==='light'?'black':'white'}}>Dark Mode</label>
                    </div>
                </div>
            </div>
        </nav>
